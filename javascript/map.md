...
<meta charset="UTF-8">
<title>地图坐标定位</title>
<script type="text/javascript" src="js/jquery.min.js"></script>   <!-- 引入jq  -->
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=67jMQ5DmYTe1TLMBKFUTcZAR"></script>  <!-- 地图ak  -->
<style type="text/css">
